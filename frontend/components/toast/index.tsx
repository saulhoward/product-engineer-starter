...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Description
        ref={ref}
        className={classNames("opacity-90", className)}
        {...props}
    />
));
